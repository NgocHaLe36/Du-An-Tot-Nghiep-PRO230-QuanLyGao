...
import gao.util.XStr;
import java.util.List;

public class GaoDAOimpl implements GaoDAO {

    private final String createSql = "INSERT INTO Gao(TenGao, XuatXu, Gia, DonViTinh, SoLuongTon, MaLoai) VALUES (?, ?, ?, ?, ?, ?)";
    private final String updateSql = "UPDATE Gao SET TenGao=?, XuatXu=?, Gia=?, DonViTinh=?, SoLuongTon=?, MaLoai=? WHERE MaGao=?";
