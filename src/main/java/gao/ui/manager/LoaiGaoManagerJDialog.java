 ...
 * @author lengh
 */
public class LoaiGaoManagerJDialog extends javax.swing.JDialog implements LoaiGaoController {

    /**
     * Creates new form LoaiGaoManagerJDialog
     */
    public LoaiGaoManagerJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoaiGaoManagerJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoaiGaoManagerJDialog dialog = new LoaiGaoManagerJDialog(new javax.swing.JFrame(), true);
    ...
    LoaiGaoDAO dao = new LoaiGaoDAOimpl();
    List<LoaiGao> items = List.of();
    ...
    @Override
    public void edit() {
        LoaiGao entity = items.get(tblCategories.getSelectedRow());
        this.setForm(entity);
    ...
    @Override
    public void setForm(LoaiGao entity) {
        txtId.setText(entity.getMaLoai());
        txtName.setText(entity.getTenLoai());
    }

    @Override
    public LoaiGao getForm() {
        LoaiGao entity = new LoaiGao();
        entity.setMaLoai(txtId.getText());
        entity.setTenLoai(txtName.getText());
        return entity;
    }
    ...
    void showDetail(int row) {
        String maLoai = tblCategories.getValueAt(row, 0).toString();
        String tenLoai = tblCategories.getValueAt(row, 1).toString();

        txtId.setText(maLoai);
        txtName.setText(tenLoai);
    }
}
